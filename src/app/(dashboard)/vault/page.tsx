...
import { VaultCredential } from "@/lib/database.types";
            ...
            <AppShell title="Vault" subtitle="Credenciais seguras">
                {isLocked ? (
                    ...
                    <div className="space-y-4 py-4">
                        {/* Security Notice & Config */}
                        <div className="flex flex-col sm:flex-row gap-3">
                            <motion.div
                                initial={{ opacity: 0, y: -10 }}
                                animate={{ opacity: 1, y: 0 }}
                                className="flex-1 flex items-center gap-3 p-4 rounded-xl bg-primary/10 border border-primary/30"
                            >
                            ...
                            >
                                {securitySettings?.pin_enabled ? "Segurança Ativa" : "Configurar Segurança"}
                            </Button>
                        </div>
